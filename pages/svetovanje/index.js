...
export default function Svetovanje() {
  ...
  return (
    <>
      <Head>
        <title>Svetovanje - Protegat.si</title>
          ...
          <div className="container">
            ...
            <form action="https://formspree.io/f/xvovedal" method="POST" className="w-full md:w-1/3">
              ...
              <div className="flex flex-col mb-3">
                ...
                <input type="text" name="naslov" id="naslov" className="bg-white px-3 py-2 border border-gray-300 focus:border-gray-400 outline-none" />
              </div>
              <div className="flex flex-col mb-3">
